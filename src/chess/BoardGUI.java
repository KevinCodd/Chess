    ...
    private Parent board() {
        ...
        for(int r = 0; r<HEIGHT; r++) {
        	for(int f = 0; f<WIDTH; f++) {
        	 Tile tile = new Tile((r + f) % 2 == 0, f, r);
        	...
        	String id = "b";
        	PieceDisp piece = new PieceDisp(color, type, id, r, f);
        	piece.setImage(image);
        	//Set king and queen size
        	if((g.getBoard()[r][f]==1)||(g.getBoard()[r][f]==2)||(g.getBoard()[r][f]==7)||(g.getBoard()[r][f]==8)) {
        		piece.setFitHeight(80);
	        	piece.setFitWidth(80);}
        	//set pawn size
        	else if((g.getBoard()[r][f]==6)||( g.getBoard()[r][f]==12)) {
        	...
        	piece.relocate(f*TILE_SIZE, (7-r)*TILE_SIZE);
